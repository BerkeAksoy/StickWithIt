...
public class BallScroll : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        unlockSpecificButton = GameObject.Find("Canvas/Ball_Scroll/Claim");
        unlocksAt = GameObject.Find("Canvas/Ball_Scroll/Claim/At").GetComponent<Text>();
    ...
    public void ClaimBall(int index)
    {
